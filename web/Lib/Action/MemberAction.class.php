...
class MemberAction extends CommonAction
{
    ...
    public function message() {
        ...
        import('ORG.Util.Page');
         // 导入分页类
        $count = $Message->where($data)->count();
         // 查询满足要求的总记录数
        $Page = new Page($count, 10);
         // 实例化分页类 传入总记录数和每页显示的记录数
        $show = $Page->show();
