    ...
    <h3 class="panel-title">积分管理</h3>
        ...
        <div class="panel-body">
		  ...
		  <table class="table table-striped  table-hover ">
									...
									<tbody>
									<?php if(is_array($crelist)): $i = 0; $__LIST__ = $crelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
											<td><?php echo ($vo["uid"]); ?></td>
											<td><?php echo ($vo["typename"]); ?></td>
											<!-- end <td><?php echo ($vo["dcsort"]); ?></td> 添加 -->
											<td>
											
											<?php echo ($vo["crecount"]); ?>
