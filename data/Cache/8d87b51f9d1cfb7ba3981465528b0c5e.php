...
<div class=" container " style="margin-top:10px;min-height:500px;">
...
<div class="row">
 ...
 <div class="panel panel-default">
	...
	<p>	<a href="<?php echo U('Address/add/');?>" data-toggle="modal" data-target="#myModal" class="btns green pull-right" >增加地址</a></p>
		...
		<?php if(is_array($adlist)): $i = 0; $__LIST__ = $adlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td>
			<?php if(($vo["addtop"]) == "1"): ?>默认<?php else: endif; ?>

			
			</td>
          <td>
			<a href="<?php echo U('Address/del/','id='.$vo['faddid']);?>" >删除</a>
			<?php if(($vo["addtop"]) == "1"): else: ?>
			<a href="<?php echo U('Address/addtop/','id='.$vo['faddid']);?>" >默认地址</a><?php endif; ?>
