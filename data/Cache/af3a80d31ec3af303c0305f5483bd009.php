...
<head>
	...
	<?php echo ($fooditem["fname"]); ?>_<?php echo ($name); ?>
...
<nav class="navbar bs-docs-nav" role="navigation" style="margin-top:10px;">
  ...
  <?php if(is_array($foodcatlist)): $i = 0; $__LIST__ = array_slice($foodcatlist,0,7,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sub): $mod = ($i % 2 );++$i;?><li> <a href="<?php echo U('List/index','id='.$sub['fcid']);?>" class="list-group-item"><span style="margin-left:60px;"><?php echo ($sub["fcname"]); ?></span><span class="fa fa-caret-right pull-right"></span></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
			...
			<div class="row top5" >
             	  <div class="col-md-6 ">
  <div class="thumbnail">
 <img src="<?php echo ($fooditem["fpic"]); ?>" class="img-responsive">
		</div>
             </div>
			   <div class="col-md-6 simpleCart_shelfItem">
			   
<h1 style="font-size:20px;" class="item_name"><?php echo ($fooditem["fname"]); ?></h1>
 <hr> 
<div class="well "> 
	<p>价格：<span class="item_price" style="color:#FF7700;font-weight:600;font-size:14px"> <?php echo ($fooditem["fprice"]); ?> </span></P>
		
	<p>数量：<input style="padding:5px 5px 5px 10px;width:40px;" value="1" size="2" class="item_Quantity" type="text"></P>
    
	<p>	<span class="pull-right "><a  href="javascript:;" class="btn btn-warning  item_add"><i class="fa fa-shopping-cart"></i> 加入购物车</a> </span></P>
...
<div style="min-height:400px;">
    <ul role="tablist" class="nav nav-tabs" id="myTab">
      <li class="active"><a data-toggle="tab" role="tab" href="#home">商品介绍</a></li>
