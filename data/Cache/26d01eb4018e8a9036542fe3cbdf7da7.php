...
<div class="panel panel-default" style="min-height:400px;">
    ...
    <h3 class="panel-title">我的外卖</h3>
  </div>
  <div class="panel-body"　>
  
  <div class="alert alert-warning"><strong> <?php echo ($username); ?></strong>,欢迎回来！</div>
  <p> 订单数：<strong style="color:#FF7700;font-size:14px"> <?php echo ($ordercount); ?></strong> <br>
 积分数：<strong style="color:#FF7700;font-size:14px"> <?php echo ($usercredit); ?></strong> 
  </p>
  <hr>
 <strong>最新动态</strong> 
 
  <ul class="list-unstyled">
  <?php if(is_array($toplist)): $i = 0; $__LIST__ = $toplist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><?php echo ($vo["atitle"]); ?></li><?php endforeach; endif; else: echo "" ;endif; ?>
