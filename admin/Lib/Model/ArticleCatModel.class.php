...
class ArticleCatModel extends Model
{
    ...
    protected $_validate = array(array('aname', 'require', '分类名称不可以为空'), array('dir', 'require', '分类目录名不可以为空'), array('dir', '', '分类目录名已经存在！', 0, 'unique', 1), array('aname', '', '分类名称已经存在！', 0, 'unique', 1), array('dir', 'english', '分类目录名为英文字符'), 　　　　　);
